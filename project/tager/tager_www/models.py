...
class UserProfile(AbstractBaseUser):
    ...
    twitter_name = models.CharField(max_length=50 , null=True , unique=True)
    twitter_token_key = models.CharField(max_length=50 , null=True , unique=True)
    twitter_token_secret = models.CharField(max_length=50 , null=True , unique=True)
