...
class UserProfile(AbstractBaseUser):
    ...
    twitter_name = models.CharField(max_length=20, null=True, unique=True)
    tw_tok_k = models.CharField(max_length=60, null=True, unique=True)
    tw_tok_s = models.CharField(max_length=60, null=True, unique=True)
